...
return {
	...
	Special = { fg = s.foreground_highlighted_4 },
	...
	["@string.special.symbol"] = { fg = s.foreground_highlighted_4 },
	...
	["@variable"] = { fg = s.foreground_highlighted_1 },
	...
	["@operator"] = { fg = s.foreground_highlighted_2, bold = false },
	["@punctuation"] = { fg = s.foreground_highlighted_2, bold = false },
	...
	["@markup.link"] = { fg = s.foreground_highlighted_3 },
	-- ["@markup.link.label"] = { fg = s.highlight_3 },
	-- ["@markup.link.url"] = { fg = s.highlight_3 },

	["@markup.raw"] = { fg = s.foreground_highlighted_4 },
